...
export type Bind = [prop: string, obj: GObject.Object, objProp?: string, transform?: (value: any) => any]
...
export default function <T extends WidgetCtor>(
  Widget: T,
  GTypeName?: string,
): {
  new (...args: any[]): {
    ...
    connectTo<GObject extends GObject.Object>(
      o: Service | GObject,
      callback: (self: any, ...args: unknown[]) => void,
      event?: string,
    ): any
    bind<GObject_1 extends GObject.Object>(
      prop:
        | "event"
        | "notify"
        | "destroy"
        ...
        | "watch-closure"
        | "vfunc-constructed"
        | "vfunc-dispatch-properties-changed"
        | "vfunc-dispose"
        | "vfunc-finalize"
        | "vfunc-get-property"
        | "vfunc-notify"
        ...
        | "create-pango-layout"
        | "device-is-shadowed"
        | "drag-begin-with-coordinates"
        | "drag-check-threshold"
        | "drag-dest-add-image-targets"
        | "drag-dest-add-text-targets"
        | "drag-dest-add-uri-targets"
        | "drag-dest-find-target"
        | "drag-dest-get-target-list"
        | "drag-dest-get-track-motion"
        | "drag-dest-set"
        | "drag-dest-set-proxy"
        | "drag-dest-set-target-list"
        | "drag-dest-set-track-motion"
        | "drag-dest-unset"
        | "drag-get-data"
        | "drag-highlight"
        | "drag-source-add-image-targets"
        | "drag-source-add-text-targets"
        | "drag-source-add-uri-targets"
        | "drag-source-get-target-list"
        | "drag-source-set"
        | "drag-source-set-icon-gicon"
        | "drag-source-set-icon-name"
        | "drag-source-set-icon-pixbuf"
        | "drag-source-set-icon-stock"
        | "drag-source-set-target-list"
        | "drag-source-unset"
        | "drag-unhighlight"
        | "ensure-style"
        | "error-bell"
        ...
        | "unregister-window"
        | "unset-state-flags"
        | "vfunc-adjust-baseline-allocation"
        | "vfunc-adjust-baseline-request"
        | "vfunc-adjust-size-allocation"
        | "vfunc-adjust-size-request"
        | "vfunc-button-press-event"
        | "vfunc-button-release-event"
        | "vfunc-can-activate-accel"
        | "vfunc-child-notify"
        | "vfunc-composited-changed"
        | "vfunc-compute-expand"
        | "vfunc-configure-event"
        | "vfunc-damage-event"
        | "vfunc-delete-event"
        | "vfunc-destroy"
        | "vfunc-destroy-event"
        | "vfunc-direction-changed"
        | "vfunc-dispatch-child-properties-changed"
        | "vfunc-drag-begin"
        | "vfunc-drag-data-delete"
        | "vfunc-drag-data-get"
        | "vfunc-drag-data-received"
        | "vfunc-drag-drop"
        | "vfunc-drag-end"
        | "vfunc-drag-failed"
        | "vfunc-drag-leave"
        | "vfunc-drag-motion"
        | "vfunc-draw"
        | "vfunc-enter-notify-event"
        | "vfunc-event"
        | "vfunc-focus"
        | "vfunc-focus-in-event"
        | "vfunc-focus-out-event"
        | "vfunc-get-accessible"
        | "vfunc-get-preferred-height"
        | "vfunc-get-preferred-height-and-baseline-for-width"
        | "vfunc-get-preferred-height-for-width"
        | "vfunc-get-preferred-width"
        | "vfunc-get-preferred-width-for-height"
        | "vfunc-get-request-mode"
        | "vfunc-grab-broken-event"
        | "vfunc-grab-focus"
        | "vfunc-grab-notify"
        | "vfunc-hide"
        | "vfunc-hierarchy-changed"
        | "vfunc-key-press-event"
        | "vfunc-key-release-event"
        | "vfunc-keynav-failed"
        | "vfunc-leave-notify-event"
        | "vfunc-map"
        | "vfunc-map-event"
        | "vfunc-mnemonic-activate"
        | "vfunc-motion-notify-event"
        | "vfunc-move-focus"
        | "vfunc-parent-set"
        | "vfunc-popup-menu"
        | "vfunc-property-notify-event"
        | "vfunc-proximity-in-event"
        | "vfunc-proximity-out-event"
        | "vfunc-query-tooltip"
        | "vfunc-queue-draw-region"
        | "vfunc-realize"
        | "vfunc-screen-changed"
        | "vfunc-scroll-event"
        | "vfunc-selection-clear-event"
        | "vfunc-selection-get"
        | "vfunc-selection-notify-event"
        | "vfunc-selection-received"
        | "vfunc-selection-request-event"
        | "vfunc-show"
        | "vfunc-show-all"
        | "vfunc-show-help"
        | "vfunc-size-allocate"
        | "vfunc-state-changed"
        | "vfunc-state-flags-changed"
        | "vfunc-style-set"
        | "vfunc-style-updated"
        | "vfunc-touch-event"
        | "vfunc-unmap"
        | "vfunc-unmap-event"
        | "vfunc-unrealize"
        | "vfunc-visibility-notify-event"
        | "vfunc-window-state-event"
        | "add-child"
        | "construct-child"
        | "custom-finished"
        | "custom-tag-end"
        ...
        | "vfunc-add-child"
        | "vfunc-construct-child"
        | "vfunc-custom-finished"
        | "vfunc-custom-tag-end"
        | "vfunc-custom-tag-start"
        | "vfunc-get-internal-child"
        | "vfunc-get-name"
        | "vfunc-parser-finished"
        | "vfunc-set-buildable-property"
        | "vfunc-set-name",
      target: GObject_1,
      targetProp: OnlyString<keyof GObject_1>,
      transform?: (value: GObject_1[OnlyString<keyof GObject_1>]) => unknown,
    ): any
    ...
    connect(
      ...
      callback: ($obj: Gtk.Widget, pspec: import("@girs/gobject-2.0").GObject.ParamSpec) => void,
    ): number
    connect(
